docker build -t cesarpenafiel2/cr_emailchecker:latest -f CR_EmailChecker/Dockerfile CR_EmailChecker/
docker build -t cesarpenafiel2/cr_notificationservice:latest -f CR_NotificationService/Dockerfile CR_NotificationService/
