...
static class T
{
    ...
    static readonly Dictionary<string, string> _ru = new()
    {
        ...
        ["Check door battery"]         = "Проверить батарейку замка",
        ["Clean AC filters"]           = "Почистить фильтры кондиционера",
        ["Check ventilator filters"]   = "Проверить фильтры вентилятора",
        ["Last done"]                  = "Последний раз",
        ["Next due"]                   = "Следующий срок",
        ["Mark Done"]                  = "Выполнено ✓",
        ["Overdue"]                    = "Просрочено",
        ["Due Soon"]                   = "Скоро срок",
        ["Never done"]                 = "Не выполнялось",
        ["Interval (weeks)"]           = "Интервал (нед.)",
        ["weeks"]                      = "нед.",
